...
#
execute if entity @s[scores={as_trigger=1000}] as @e[type=armor_stand,distance=..3,tag=!as_locked,nbt=!{Marker:1b},sort=nearest,limit=1] run tellraw @p {"text":"<Stick_God> Armor stand locked","color":"dark_green"}
...
#
execute if entity @s[scores={as_trigger=1001}] as @e[type=armor_stand,distance=..3,tag=as_locked,tag=!as_sealed,nbt=!{Marker:1b},sort=nearest,limit=1] run tellraw @p {"text":"<Stick_God> Armor stand unlocked","color":"dark_green"}
...
#
execute if entity @s[scores={as_trigger=1002},gamemode=creative] as @e[type=armor_stand,distance=..3,tag=!as_sealed,nbt=!{Marker:1b},sort=nearest,limit=1] run tellraw @p {"text":"<Stick_God> Armor stand sealed","color":"dark_green"}
...
#
execute if entity @s[scores={as_trigger=1003},gamemode=creative] as @e[type=armor_stand,distance=..3,tag=as_sealed,nbt=!{Marker:1b},sort=nearest,limit=1] run tellraw @p {"text":"<Stick_God> Armor stand unsealed","color":"dark_green"}
