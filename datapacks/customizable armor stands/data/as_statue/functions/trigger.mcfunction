...
# Copy and paste
#
execute if entity @s[scores={as_trigger=1004}] unless entity @s[nbt=!{SelectedItem:{id:"minecraft:written_book",tag:{datapack:"ArmorStatuesV2"}}}] as @e[type=armor_stand,tag=as_selected] run function as_statue:trigger/copy
execute if entity @s[scores={as_trigger=1005}] unless entity @s[nbt=!{SelectedItem:{id:"minecraft:written_book",tag:{datapack:"ArmorStatuesV2",SavedPose:{PoseSaved:1b}}}}] as @e[type=armor_stand,tag=as_selected] run function as_statue:trigger/paste
#
# Lock and seal
#
