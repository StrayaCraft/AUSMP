...
execute as @e[type=minecraft:wandering_trader,tag=!has_new_hermit_trades] at @s run scoreboard players set @s math_input1 0
execute as @e[type=minecraft:wandering_trader,tag=!has_new_hermit_trades] at @s run scoreboard players set @s math_input2 0
